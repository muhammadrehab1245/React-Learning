...
const Details = () => {
  ...
  <div className="accordion-item">
    <h2 style={style} className="accordion-header" id="headingOne">
    ...
    <div style={style} id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
  ...
  <div className="accordion-item">
    <h2 style={style} className="accordion-header" id="headingThree">
...
<button onClick={togglemode} type="button" className="btn btn-outline-dark">{btntext}</button>
    </div>;
}
